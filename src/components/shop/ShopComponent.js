...
import '../Route/Categories/Mens/MensContainer.css'
      ...
      <>
          <div className="col-md-4" id={id}>
              <div className="card p-3 my-3" >
                  <img style={{"height": "281px"}} src={image} className="card-img-top w-50 m-auto" alt="..." />
                  <div className="card-img-overlay">
                        <div className='cardContent'>
                        <h5 className="card-title cardText">{title.slice(0, 30)}</h5>
